...
/*
    ...
    If you would like to store your view in a Stack Please Look at WindowNavigationStack to do this. 
 */

import Foundation
import SwiftUI

public final class WindowNavigateCurrentView : ObservableObject {
