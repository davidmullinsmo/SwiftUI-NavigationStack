...
/*
    ...
    If you would like to store your view in a Stack Please Look at SettingsNavigationStack to do this.
 */

import Foundation
import SwiftUI

public final class SettingsNavigateCurrentView : ObservableObject {
