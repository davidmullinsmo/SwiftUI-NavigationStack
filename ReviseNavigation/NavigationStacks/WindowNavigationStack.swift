...
/*
 Once you load a Window this will be the NavigationStack you should be working with.
 If you follow our directions, this is the stack that should be loaded as an EnvironmentObject to the RootView of your Window.
 Each Windows Loaded has it own NavigationStack!
...
public final class WindowNavigationStack : ObservableObject {
