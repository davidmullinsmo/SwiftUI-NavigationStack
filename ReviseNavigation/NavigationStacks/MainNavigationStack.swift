...
/*
 Once you Application loads this will be the NavigationStack you should be working with.
 If you follow our directions, this is the stack that should be loaded as an EnvironmentObject to the RootView of your Application.
 Each Window of the Application has it own NavigationStack. So, when someone clicks cmd+N to open a new Windows each Window has it own Navigation Stack. 
